...
data_sort_option_low = "lohi"
data_sort_option_low_2 = "Price (low to high)"
data_first_product = "inventory-item-sauce-labs-onesie-img"
data_first_product_2 = "Sauce Labs Onesie"