...
from test_xyz_playwright.test_xyz_steps import *


def test_login_successful_bank(page: Page, login_bank_customer):
    login_bank_customer()
    assert page.url == 'https://www.globalsqa.com/angularJs-protractor/BankingProject/#/customer'
    print('Вход успешный')


def test_login_successful_potter (browser, selenium_action, login_bank_customer, login_bank_potter):
...
def test_login_and_back_home_successful_potter(browser, selenium_action, login_bank_customer,
...
def test_successful_add_customer(selenium_action, login_bank_manager, add_customer, list_customer):
